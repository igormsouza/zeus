...
namespace Client.Zeus.App
{
    ...
    {
        public static HelperResult PagerList(this WebGrid webGrid, WebGridPagerModes mode = WebGridPagerModes.NextPrevious | WebGridPagerModes.Numeric,
            string firstText = null, string previousText = null, string nextText = null, string lastText = null, int numericLinksCount = 5,
            string paginationStyle = null)
        {
            ...
            if ((mode & WebGridPagerModes.FirstLast) == WebGridPagerModes.FirstLast)
            {
            ...
            if ((mode & WebGridPagerModes.NextPrevious) == WebGridPagerModes.NextPrevious)
            {
            ...
            if ((mode & WebGridPagerModes.Numeric) == WebGridPagerModes.Numeric && (totalPages > 1))
            {
